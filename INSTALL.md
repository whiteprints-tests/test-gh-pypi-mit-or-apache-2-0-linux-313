...
```console
pip install test-gh-pypi-mit-or-apache-2-0-linux-313
```
...
```console
pip install git+ssh://git@github.com/whiteprints-tests/test-gh-pypi-mit-or-apache-2-0-linux-313
```
...
[package]: https://pypi.org/project/test-gh-pypi-mit-or-apache-2-0-linux-313
